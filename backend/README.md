...
## Project Structure
    ...
    ├── customerservice_32685  # Django project configurations
...
1. Clone this repo and `cd customerservice_32685`
...
2. Clone this repo and `cd customerservice_32685`
